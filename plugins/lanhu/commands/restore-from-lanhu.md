...
4. Use `lanhu-generate-baseline` to create the static parity baseline with `scripts/restore_lanhu.py`.
...
7. Use `lanhu-verify-parity` for local verification and summarize parity plus known deltas.
