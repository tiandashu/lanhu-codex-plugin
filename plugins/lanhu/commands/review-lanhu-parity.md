...
4. Compare layout, typography, colors, assets, clipping, and interactions.
5. Report findings first, ordered by severity, then list checked evidence and suggested fixes.
